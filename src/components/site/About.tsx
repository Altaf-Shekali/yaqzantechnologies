...
const timeline = [
  { year: "2025", title: "Founded", text: "Yaqzan Technologies founded with a vision to build privacy-first, India-first intelligent software." },
  { year: "2026", title: "First Products", text: "Launching KAVAL — Kannada-first digital safety — and HADI, our AI assistant with memory and automation." },
  { year: "2027", title: "Next Horizon", text: "Scaling our AI OS and expanding into new consumer and developer products." },
];
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="mt-6 text-muted-foreground text-lg">
            We craft software, cloud platforms, and AI systems that turn ambitious ideas into measurable outcomes.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="space-y-10">
            {timeline.map((t, i) => (
              <div key={t.year} className={`grid md:grid-cols-2 gap-6 items-center ${i % 2 ? "md:[&>*:first-child]:order-2" : ""}`}>
                <div className={`${i % 2 ? "md:text-left md:pl-12" : "md:text-right md:pr-12"}`}>
                  <div className="inline-block font-display text-5xl font-bold text-gradient">{t.year}</div>
                </div>
